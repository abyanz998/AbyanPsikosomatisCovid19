...
//        val nama1 = nama.toString()
//
//        val tampilnama = findViewById<TextView>(R.id.iduser1)
//        tampilnama.text = nama1
        var intent = intent
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                override fun onResponse(response: JSONObject) {
                    ...
                    for (i in 0 until jsonArray.length()) {
                        ...
                        val id = jsonObject.optString("id_user").toString()  // ini optString gapapa kalau langsung di setText masihh bisa pake nama1
